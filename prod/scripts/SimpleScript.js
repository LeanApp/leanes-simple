...
var _default = Module => {
  ...
  let SimpleScript = (_dec = partOf(Module), _dec2 = inject(`Factory<${SIMPLE_PROXY}>`), initialize(_class = _dec(_class = (_class2 = (_temp = _class3 = class SimpleScript extends Script {
    constructor(...args) {
      super(...args);
    ...
    writable: true,
    initializer: null
  }), (0, _applyDecoratedDescriptor2.default)(_class2.prototype, "_simpleProxy", [property], Object.getOwnPropertyDescriptor(_class2.prototype, "_simpleProxy"), _class2.prototype), (0, _applyDecoratedDescriptor2.default)(_class2.prototype, "body", [method], Object.getOwnPropertyDescriptor(_class2.prototype, "body"), _class2.prototype)), _class2)) || _class) || _class);
};
